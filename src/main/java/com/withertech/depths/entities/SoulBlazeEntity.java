...
public class SoulBlazeEntity extends HostileEntity
{
	private float eyeOffset = 0.5F;
	private int eyeOffsetCooldown;
	private static final TrackedData<Byte> BLAZE_FLAGS;

	public SoulBlazeEntity(EntityType<? extends SoulBlazeEntity> entityType, World world) {
	...
	protected void initGoals() {
		this.goalSelector.add(4, new SoulBlazeEntity.ShootFireballGoal(this));
	...
	static class ShootFireballGoal extends Goal {
		...
		public ShootFireballGoal(SoulBlazeEntity blaze) {
			this.blaze = blaze;
